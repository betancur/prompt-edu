...
function Library() {
  ...
  return (
    <>
      <Helmet>
        <title>Biblioteca de prompts | Encuentra y utiliza prompts educativos</title>
        <meta name="description" content="Browse our collection of AI prompts designed for education. Find and use effective prompts for your classroom." />
      </Helmet>
