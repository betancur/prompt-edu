...
function DocumentLibrary() {
  ...
  return (
    <>
      <Helmet>
        <title>Biblioteca de Documentos | Aula Prompts</title>
        <meta name="description" content="Explora nuestra colección de documentos, guías y recursos para mejorar tus habilidades en la creación de prompts educativos." />
      </Helmet>
