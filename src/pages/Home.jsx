...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Aula Prompts - Librería de Prompts para Educadores | IA en Educación</title>
        <meta name="description" content="Discover the art of prompt engineering with our comprehensive library of resources, frameworks, and best practices." />
      </Helmet>
      <div>
